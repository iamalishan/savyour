...
import '../common_widgets/notification_button.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ReuseText(title: controller.product!.title, fontWeight: FontWeight.bold),
          if (controller.product!.vendor != null) ReuseText(title: controller.product!.vendor!),
          SizedBox(height: 20),
          Row(
              ...
              GestureDetector(
                ...
                child: Row(
                  children: [
                    ClipOval(
                      child:
                      controller.brand!.imageBase64 != null?
                          Image.memory(
                      ...
                      controller.brand!.imageUrl == null
                          ? Image.asset(
                    ...
                    SizedBox(width: 10),
                    ReuseText(title: controller.brand!.name, fontWeight: FontWeight.bold),
                  ],
                ),
              ),
              Column(
                children: [
                  if (controller.product!.variants.first.price != null)
                    ReuseText(
                  ...
                  if (controller.product!.variants.first.compareAtPrice
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 5),
                        if (controller.product!.variants.first.discount != null)
                          Container(
                            ...
                            child: ReuseText(
                              title: "-${controller.product!.variants.first.discount}%",
                              fontColor: Colors.red,
                              fontSize: 10,
                            ),
                          ),
          ...
          SizedBox(height: 20),
          Visibility(
            visible: controller.product!.variants.first.compareAtPrice == null,
            child: ReuseText(
              title:
              "We don't have any price history for this product yet.",
            ),
          ),
          Visibility(
            visible: controller.product!.variants.first.compareAtPrice != null,
          ...
          if (controller.product!.description != null)
            ReuseText(title: controller.product!.description.trim()),
