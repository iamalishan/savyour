...
class WebShopButton extends StatelessWidget {
  WebShopButton({super.key});
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () async {
              // openInSameTab("${productCon.brand!.url}/products/${productCon.product!.handle}");
              // String currentUrl =
              //     "${productCon.brand!.url}/products/${productCon.product!.handle}";
              // launchUrl(Uri.parse(currentUrl));
              Utils.launchBrandProduct("${productCon.brand!.url}/products/${productCon.product!.handle}",
                FeedModel(
                  type: 'product_buy',
